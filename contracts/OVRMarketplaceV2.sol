    ...
    PausableUpgradeable
{
    ...
    // prettier-ignore
    event OfferPlaced(uint256 indexed nftId, address indexed sender, uint256 value, uint256 timestamp);
    // prettier-ignore
    event OfferCancelled(uint256 indexed nftId, address indexed sender, address indexed to, uint256 timestamp);
    // prettier-ignore
    event OfferAccepted(uint256 indexed nftId, address indexed owner, address indexed to, uint256 value, uint256 timestamp);
    // prettier-ignore
    event Sold(uint256 indexed nftId, address indexed seller, uint256 value, uint256 timestamp);
    // prettier-ignore
    event ContainerSold(uint256 indexed containerId, address indexed seller, uint256 value, uint256 timestamp);
    // prettier-ignore
    event ContainerBought(uint256 indexed containerId, uint256 value, address indexed sender, uint256 timestamp);
    // prettier-ignore
    event SellCancelled(uint256 indexed nftId, address indexed sender, uint256 timestamp);
    // prettier-ignore
    event SellContainerCancelled(uint256 indexed containerId, address indexed sender, uint256 timestamp);
    // prettier-ignore
    event Bought(uint256 indexed nftId, uint256 value, address indexed sender, uint256 timestamp);
    // prettier-ignore
    event PriceContainerChanged(uint256 indexed containerId, uint256 newPrice, uint256 timestamp);
    // prettier-ignore
    event PriceLandChanged(uint256 indexed landId, uint256 newPrice, uint256 timestamp);
    ...
    function placeOffer(uint256 _nftId, uint256 _value) public whenNotPaused {
        ...
        emit OfferPlaced(_nftId, _msgSender(), _value, currentTimestamp);
    }
        ...
        whenNotPaused
    {
        ...
        emit OfferAccepted(_nftId, _msgSender(), to, value, currentTimestamp);
    }
        ...
        whenNotPaused
    {
        ...
        emit Sold(_nftId, _msgSender(), _value, currentTimestamp);
    }
        ...
        whenNotPaused
    {
        ...
        emit ContainerSold(_containerId, _msgSender(), _value, _now());
    }
    ...
    function updatePriceLand(uint256 _nftId, uint256 _price)
        ...
        isLandOwner(_nftId)
    {
        // TODO ATTENZIONE AI MESSAGGI DI ERRORE
